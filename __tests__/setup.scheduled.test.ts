...
import { create_github_output, delete_github_output, execute, read_github_output, setup_runner_temp_and_cache } from './utils'
        ...
        beforeEach(async (): Promise<void> => {
            ...
            while (true) {
                ...
                if (res.message.statusCode === hc.HttpCodes.Forbidden && res.message.headers['retry-after']) {
                    ...
                    core.info(`Setting the timeout entry to ${timeout} after retry-after header entry`)
                    break
